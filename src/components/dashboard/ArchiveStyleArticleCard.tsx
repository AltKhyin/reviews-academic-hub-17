...
export const ArchiveStyleArticleCard: React.FC<ArchiveStyleArticleCardProps> = ({ 
  ...
  return (
    <Card 
      ...
      onClick={handleClick}
    >
      {/* Cover Image with Archive Styling */}
      <div className={`relative overflow-hidden ${variant === 'featured' ? 'aspect-video' : 'aspect-video'}`}>
        ...
        {/* Featured badge with Archive styling */}
      ...
      {/* Content Section positioned at bottom with Archive styling */}
      <div className="absolute bottom-0 left-0 right-0 p-4 z-10">
        {/* Title with enhanced text shadow */}
        <h3 className={`font-semibold leading-tight mb-2 line-clamp-2 text-white ${
        ...
        {/* Micro Information with enhanced text shadow */}
      ...
      {/* Detailed Information Overlay - Archive style */}
