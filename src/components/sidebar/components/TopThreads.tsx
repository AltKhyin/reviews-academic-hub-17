          ...
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="h-3 bg-gray-800/30 rounded w-8 animate-pulse" />
              </div>
            </div>
          ))}
        </div>
  ...
  if (!threads?.length) {
    return (
      <div className="space-y-2">
        <h3 className="text-xs font-medium text-gray-400 uppercase tracking-wide">Discussões em Alta</h3>
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        {threads.slice(0, 3).map((thread, index) => (
          <div
            key={thread.id}
            className="cursor-pointer hover:bg-gray-800/20 -mx-2 px-2 py-2 rounded transition-colors group"
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-gray-400 font-medium line-clamp-2 group-hover:text-gray-300 transition-colors">
                    {thread.title}
                  </p>
                </div>
              </div>
