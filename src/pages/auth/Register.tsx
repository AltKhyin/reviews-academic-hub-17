...
const Register: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        <h2 className="text-2xl font-serif font-medium text-[#212121]">Crie sua conta</h2>
        <p className="text-[#8E9196] mt-2">Acesse reviews de artigos científicos</p>
      </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-sm text-[#8E9196]">
          Já tem uma conta?{' '}
          <Link to="/auth/login" className="text-[#212121] hover:underline">
            Entre agora
          </Link>
        </p>
      </div>
