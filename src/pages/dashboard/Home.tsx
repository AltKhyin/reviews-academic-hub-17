...
// ABOUTME: Exact duplicate of Dashboard component for /home route - no UI changes
...
const Home = () => {
  ...
  console.log('Home: Rendering with', issues?.length || 0, 'issues');
  ...
  console.log('Home: Visible sections:', enabledSections.map(s => s.id));
  console.log('Home: Featured issue:', featuredIssue?.id);
