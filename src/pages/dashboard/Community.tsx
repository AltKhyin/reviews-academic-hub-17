...
const Community = () => {
  ...
  return (
    <div className="container mx-auto py-6 max-w-4xl">
      ...
      {/* New cohesive navigation block */}
      <div className="bg-muted rounded-xl p-6 shadow-sm mb-8">
        {/* Title and subtitle */}
        <div className="mb-6">
        ...
        {/* Search and new post action line */}
        <div className="flex flex-wrap md:flex-nowrap items-center gap-4 mb-6">
          <form onSubmit={handleSearch} className="relative w-full max-w-md">
            <Input
              ...
              className="pr-10 bg-background border px-3 py-2 rounded-md text-sm"
            />
            <Button 
              type="submit" 
              size="sm" 
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 border border-border rounded-md overflow-hidden">
